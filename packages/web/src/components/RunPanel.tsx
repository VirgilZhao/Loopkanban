...
import {
  Archive, ArchiveRestore, Bot, Check, GitMerge, Paperclip, Play, Send, Square, Trash2, TriangleAlert,
  Upload, User, X,
} from 'lucide-react'
...
import type {
  Agent, Attachment, DiffView as Diff, Project, Run, StreamEvent, Task, TaskComment, TaskEdit,
} from '@/types.ts'
      ...
      <div className="flex-none space-y-2 border-t border-hairline px-4 py-3">
        ...
        >
          <Textarea
            ...
            className={cn('min-h-20', dragOver && 'border-sodium-deep')}
          />
          {dragOver ? (
            <div className={cn(
